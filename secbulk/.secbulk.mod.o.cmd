cmd_/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o :=  gcc-4.6 -Wp,-MD,/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/.secbulk.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.6/include -I/usr/src/linux-headers-3.2.0-4-common/arch/x86/include -Iarch/x86/include/generated -Iinclude  -I/usr/src/linux-headers-3.2.0-4-common/include -include /usr/src/linux-headers-3.2.0-4-common/include/linux/kconfig.h   -I/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=generic -Wa,-mtune=generic32 -ffreestanding -fstack-protector -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -DCONFIG_AS_CFI_SECTIONS=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Wframe-larger-than=1024 -Wno-unused-but-set-variable -fomit-frame-pointer -fno-var-tracking-assignments -g -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(secbulk.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(secbulk)" -DMODULE  -c -o /opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o /opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.c

source_/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o := /opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.c

deps_/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o := \
...
/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o: $(deps_/opt/s3c2440_work/tmp/dnw/dnw_for_linux/secbulk/secbulk.mod.o)
